...
<body>
	...
	<div id="mainWrapper">
		<span class="success" style="text-align: center;display: block;"><%=Util.getValue(session, "caseUpdatedPass") %></span>
		<table>
			<caption>Update Cases</caption>
			<thead>
				<tr>
		...
		<p class="pageNumbers">
			<%
				for(int i = 1; i <= pages; i++) {
					%>
						<a class="pageIndex" href="updateCases.jsp?page=<%=i %>"><%=i %></a>
					<%
				}
			%>
		</p>
