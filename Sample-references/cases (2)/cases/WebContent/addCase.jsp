...
<head>
	...
	<script type="text/javascript">
		function validate() {
			...
			statuteNumber = document.getElementById("statuteNumber").value;
			if(name.trim().length == 0) {
				...
				return false;
			} else if(statuteNumber.trim().length == 0) {
				errorShow.innerHTML = "Invalid statute number";
				return false;
			}
			return true;
		}
	...
	<div id="mainWrapper">
		...
		<form action="AddCaseServlet" method="POST" onsubmit="return validate()">
			<fieldset>
				...
				<input type="text" name="statuteNumber" id="statuteNumber" />
				<br />
